...
const Progress = ({ value, className = "" }) => (
  <div className={`w-full bg-gray-200 rounded-full h-2 ${className}`}>
    <div
      className="bg-[#0C2D48] h-2 rounded-full transition-all duration-300 ease-out"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Upload and manage high-quality images of your product
        </CardDescription>
      </CardHeader>
...
export default function EditProductPage() {
  ...
  const validateForm = useCallback(() => {
    ...
    const originalPriceError = validateRequired(
      editingProduct.originalPrice,
      "Original price"
    );
    if (originalPriceError) errors.originalPrice = originalPriceError;
    else if (
      isNaN(Number(editingProduct.originalPrice)) ||
      Number(editingProduct.originalPrice) <= 0
    ) {
      errors.originalPrice = "Original price must be a valid positive number";
    }

    const primaryCategoryError = validateRequired(
      editingProduct.primaryCategory,
      "Primary category"
    );
    ...
    weightFields.forEach((field) => {
      if (
        ...
        (isNaN(Number(editingProduct[field])) ||
          Number(editingProduct[field]) < 0)
      ) {
    ...
    if (
      editingProduct.specificGravity &&
      Number(editingProduct.specificGravity) <= 0
    ) {
  ...
  const isFormValid =
    Object.keys(validationErrors).length === 0 && editingProduct.name.trim();
  const hasDiscountedPrice =
    editingProduct.discountedPrice &&
    Number(editingProduct.discountedPrice) > 0;
  const discountPercentage = hasDiscountedPrice
    ? Math.round(
        ((Number(editingProduct.originalPrice) -
          Number(editingProduct.discountedPrice)) /
          Number(editingProduct.originalPrice)) *
          100
      )
    : 0;
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button
            ...
            className="bg-[#0C2D48] hover:bg-[#0c2d40] text-white min-w-[140px]"
          >
            {saving ? (
              <div className="flex items-center">
                <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="pink-sapphire">
                          Pink Sapphire
                        </SelectItem>
                        <SelectItem value="blue-sapphire">
                          Blue Sapphire
                        </SelectItem>
                        <SelectItem value="yellow-sapphire">
                          Yellow Sapphire
                        </SelectItem>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("secondaryCategory", value)
                      }
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="gemstone-rings">
                          Gemstone Rings
                        </SelectItem>
                        <SelectItem value="gemstone-pendants">
                          Gemstone Pendants
                        </SelectItem>
                        <SelectItem value="loose-gemstones">
                          Loose Gemstones
                        </SelectItem>
                      </SelectContent>
                    </Select>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("weightRatti", e.target.value)
                      }
                      placeholder="0.00"
                      className={`${
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("weightCarat", e.target.value)
                      }
                      placeholder="0.00"
                      className={`${
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("poojaEnergization", e.target.value)
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("dimensionType", e.target.value)
                      }
                ...
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleInputChange("isAvailable", Boolean(checked))
                    }
                  />
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Uncheck this to temporarily hide the product from
                      customers
                    </p>
                  </div>
                  <Badge
                    variant={
                      editingProduct.isAvailable ? "default" : "secondary"
                    }
                  >
